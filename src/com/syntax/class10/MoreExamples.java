...
public class MoreExamples {
	...
	public static void main(String[] args) {
		...
		/*
		 * enchanced for loop uses variables to access elements for an array outer for
		 * loops -> iterates over 1D array inner loop --> iterates over elements of each
		 * 1D array
		 */
